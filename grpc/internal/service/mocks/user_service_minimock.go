...
//go:generate minimock -i github.com/f1xend/auth/internal/service.UserService -o user_service_minimock.go -n UserServiceMock
...
type UserServiceMock struct {
	...
	funcCreate          func(ctx context.Context, req *model.UserInfo) (i1 int64, err error)
	inspectFuncCreate   func(ctx context.Context, req *model.UserInfo)
	...
	funcUpdate          func(ctx context.Context, req *model.UpdateUser) (err error)
	inspectFuncUpdate   func(ctx context.Context, req *model.UpdateUser)
...
func (mmCreate *mUserServiceMockCreate) Expect(ctx context.Context, req *model.UserInfo) *mUserServiceMockCreate {
...
func (mmCreate *mUserServiceMockCreate) Inspect(f func(ctx context.Context, req *model.UserInfo)) *mUserServiceMockCreate {
...
func (mmCreate *mUserServiceMockCreate) Set(f func(ctx context.Context, req *model.UserInfo) (i1 int64, err error)) *UserServiceMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mUserServiceMockCreate) When(ctx context.Context, req *model.UserInfo) *UserServiceMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserServiceMock.Create mock is already set by Set")
	}
...
func (mmCreate *UserServiceMock) Create(ctx context.Context, req *model.UserInfo) (i1 int64, err error) {
...
func (mmUpdate *mUserServiceMockUpdate) Expect(ctx context.Context, req *model.UpdateUser) *mUserServiceMockUpdate {
	...
	mmUpdate.defaultExpectation.params = &UserServiceMockUpdateParams{ctx, req}
...
func (mmUpdate *mUserServiceMockUpdate) Inspect(f func(ctx context.Context, req *model.UpdateUser)) *mUserServiceMockUpdate {
...
func (mmUpdate *mUserServiceMockUpdate) Set(f func(ctx context.Context, req *model.UpdateUser) (err error)) *UserServiceMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mUserServiceMockUpdate) When(ctx context.Context, req *model.UpdateUser) *UserServiceMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserServiceMock.Update mock is already set by Set")
	}
	...
	expectation := &UserServiceMockUpdateExpectation{
		mock:   mmUpdate.mock,
		params: &UserServiceMockUpdateParams{ctx, req},
	}
...
func (mmUpdate *UserServiceMock) Update(ctx context.Context, req *model.UpdateUser) (err error) {
	...
	mm_params := UserServiceMockUpdateParams{ctx, req}
	...
	if mmUpdate.UpdateMock.defaultExpectation != nil {
		...
		mm_got := UserServiceMockUpdateParams{ctx, req}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
	...
	mmUpdate.t.Fatalf("Unexpected call to UserServiceMock.Update. %v %v", ctx, req)
	return
}
