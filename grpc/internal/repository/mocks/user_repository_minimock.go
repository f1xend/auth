...
//go:generate minimock -i github.com/f1xend/auth/internal/repository.UserRepository -o user_repository_minimock.go -n UserRepositoryMock
...
func (mmCreate *mUserRepositoryMockCreate) Expect(ctx context.Context, req *model.UserInfo) *mUserRepositoryMockCreate {
...
func (mmCreate *mUserRepositoryMockCreate) Inspect(f func(ctx context.Context, req *model.UserInfo)) *mUserRepositoryMockCreate {
...
func (mmCreate *mUserRepositoryMockCreate) Set(f func(ctx context.Context, req *model.UserInfo) (i1 int64, err error)) *UserRepositoryMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mUserRepositoryMockCreate) When(ctx context.Context, req *model.UserInfo) *UserRepositoryMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserRepositoryMock.Create mock is already set by Set")
	}
...
func (mmCreate *UserRepositoryMock) Create(ctx context.Context, req *model.UserInfo) (i1 int64, err error) {
...
func (mmUpdate *mUserRepositoryMockUpdate) Expect(ctx context.Context, req *model.UpdateUser) *mUserRepositoryMockUpdate {
...
func (mmUpdate *mUserRepositoryMockUpdate) Inspect(f func(ctx context.Context, req *model.UpdateUser)) *mUserRepositoryMockUpdate {
...
func (mmUpdate *mUserRepositoryMockUpdate) Set(f func(ctx context.Context, req *model.UpdateUser) (err error)) *UserRepositoryMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mUserRepositoryMockUpdate) When(ctx context.Context, req *model.UpdateUser) *UserRepositoryMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserRepositoryMock.Update mock is already set by Set")
	}
...
func (mmUpdate *UserRepositoryMock) Update(ctx context.Context, req *model.UpdateUser) (err error) {
