...
//go:generate minimock -i github.com/f1xend/platform-common/pkg/db.TxManager -o tx_manager_minimock.go -n TxManagerMock
...
import (
	...
	mm_db "github.com/f1xend/platform-common/pkg/db"
